...
const ProposalList = (props) => {  
  ...
  return (  
    <div>
      ...
      <div>
        {props.openForVotes?<span className="ml-10 bg-green-100 text-green-800 py-1 px-3 rounded-full font-medium">Open</span>:<span className="ml-10 bg-red-100 text-red-800 py-1 px-3 rounded-full font-medium">Inactive</span>}
      </div>
      </div>
    </div>
  );
