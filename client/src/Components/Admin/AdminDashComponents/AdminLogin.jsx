            ...
            <div className="relative w-2/5 my-6 mx-auto">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full outline-none focus:outline-none">
                ...
                <div className="flex items-center justify-center p-3 border-t border-solid border-slate-200 rounded-b">
                    {otp.length==6?<button id="otp-button" className='bg-teal-400 font-bold text-lg text-sky-800 rounded-lg py-2 px-4' onClick={()=>checkOTP(otp)}>Verify</button>:<h1 className='bg-gray-600 font-bold text-lg text-gray-400 rounded-lg py-2 px-4'>Verify</h1>}
                </div>
              </div>
            </div>
          </div>
