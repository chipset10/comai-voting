...
import AddProposals from './AdminDashComponents/AddProposals'
import ViewResults from './AdminDashComponents/ViewResults'
import ViewVoterList from './AdminDashComponents/ViewVoterList'
import AuditProposals from './AdminDashComponents/AuditProposals'
      ...
      <Routes>
        <Route element={<AdminLoginAuth/>}>
          <Route element={<AdminLayout/>}>
            ...
            <Route exact path='/AddProposals' element={<AddProposals/>}/>
            <Route exact path='/AddCandidates' element={<AddCandidates/>}/>
            <Route exact path='/AuditProposals' element={<AuditProposals/>}/>
