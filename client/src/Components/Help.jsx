                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            ...
                            <details className="bg-slate-800 shadow-lg rounded-lg group m-4 p-4 ease-in-out duration-500">
                                ...
                                <div className="p-4">
                                    ...
                                    <li>Enter Name,Community ID,Email ID in appropriate formats!</li>
                                    <li>Upload scanned copy of Community ID in jpg/png/pdf formats of size less than 100Kb only</li>
                            ...
                            <details className="bg-slate-800 shadow-lg rounded-lg group m-4 p-4 ease-in-out duration-500">
                                ...
                                <div className="p-4">
                                    ...
                                    <li>Enter registered Community ID and password in the given input space</li>
                            ...
                            <details className="bg-slate-800 shadow-lg rounded-lg group m-4 p-4 ease-in-out duration-500">
                                ...
                                <div className="p-4">
                                    ...
                                    <li>Cast Vote : User can cast a vote only once iff he is mapped to a poll by the admin. If a poll is available, click on Cast Vote button under the poll card, choose a candidate, confirm sproposal and accept transaction in Metamask</li>
                        ...
                        <Tab.Panel>
                            ...
                            <details className="bg-slate-800 shadow-lg rounded-lg group m-4 p-4 ease-in-out duration-500">
                                ...
                                <div className="p-4">
                                    <li>From the Sidebar, adminisrator can access the pages to validate registered users, view voter list, add proposal and candidates, audit proposals, and view results of completed polls</li>
                                    ...
                                    <li>Add Proposal : Add an proposal for voters to participate in</li>
                                    <li>Add Candidates : Add and map a candidate to an added proposal for voters to vote to</li>
                                    <li>Audit Proposals : Activate/De-activate proposals, view the candidates mapped to each poll, map voters to the polls individually, and remove proposals, once finished</li>
